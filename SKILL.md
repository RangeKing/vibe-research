...
- Do not claim readiness, completeness, or successful revision without fresh verification against the relevant packet, source artifact, or audit checklist. A score at or above 90/100, or 9/10, requires passing the Methods/SI reproducibility gate, not only package-cleanliness checks.
...
- target-journal scores at or above 90/100 require a passed Methods/SI reproducibility gate with formal equations and, for `.docx`, verified Office Math objects when formulas are part of the work
