...
- For **manuscript story, abstract, title, journal positioning, or figure-order assessment**, identify the strongest defensible scientific product before leading with limitations. Decide whether quality control, missingness, robustness, and uncertainty are functioning as confidence architecture or have swallowed the manuscript's main contribution.
- Before calling a manuscript merely preliminary, exploratory, or a data audit, run limitation triage: conclusion-overturning, main-analysis-scope, precision/ranking, or causal-language-boundary. Only conclusion-overturning limitations should usually collapse the central story.
